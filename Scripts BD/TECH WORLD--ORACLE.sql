...
CREATE TABLE DETALLE_ORDEN (
  DT_COD NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  DT_OC_COD NUMBER(10) NOT NULL,
  DT_PRODUCTO_COD NUMBER(10) NOT NULL,
  DT_CANTIDAD NUMBER(10) NULL,
  DT_PRECIO FLOAT NULL,
  PRIMARY KEY (DT_COD),
  CONSTRAINT fk_DETALLE_ORDEN_ORDEN_COMPRA
    FOREIGN KEY (DT_OC_COD)
...
CREATE TABLE ORDEN_INGRESO (
  ...
  OI_FECHAINGRESO VARCHAR2(45) NULL,
  PRIMARY KEY (OI_COD),
