...
CREATE TABLE IF NOT EXISTS DETALLE_ORDEN (
  DT_COD INT NOT NULL AUTO_INCREMENT,
  DT_OC_COD INT NOT NULL,
  DT_PRODUCTO_COD INT NOT NULL,
  DT_CANTIDAD INT NULL,
...
CREATE TABLE IF NOT EXISTS ORDEN_INGRESO (
  ...
  OI_FECHAINGRESO VARCHAR(45) NULL,
  PRIMARY KEY (OI_COD),
